...
var notificationController = require("./../controllers/notification.controller")(exp);
...
module.exports = function(app) {
    ...
    function route() {
                ...
                req.logIn(user, function(err) {
                    ...
                    if (req.body.remember !== undefined) {
                        res.cookie('user', user._id + ";" + user.local.password, {
                            maxAge: 2592000000, secure: true , httpOnly: true
        ...
        exp.get("/notifications", notificationController.getNotifications); 

/*
        exp.get("/room/123456", roomsController.room);
        exp.get("/room/789", roomsController.room2);
        exp.route("/notifications")
        .get(notificationController.getNotifications)
        .post(notificationController.setNotification)
      //  .put()
      //  .delete()
      ;*/
